    ...
    public class Program
    {
        public static void Main()
        {
            while (true)
            {
                ...
                Helper.Functions functions = new Helper.Functions();
                //SlotsDb slotsDb = new SlotsDb();
                Tickets dBTickets = new Tickets();
                Slots slots = new Slots();
                Vehicles dBVehicles = new Vehicles();
                                ...
                                do
                                {
                                    ...
                                    if (SelectedSlot != null)
                                    {
                                        do
                                        {
                                            ...
                                            var VehicleNumber = Display.Scan();
                                            switch (choice)
                                            {
                                                case 1:
                                            ...
                                            if (validation.IsValidVehicleNumber(VehicleNumber) == true)
                                            {
                                                //bool isSame = ParkingServices.CheckSimialarVehicleNo(VehicleNumber);
                                                //if (isSame == false)
                                                //{
                                                validity = true;
                                                //}
